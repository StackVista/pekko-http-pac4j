...
inThisBuild(List(organization := "io.github.stackvista", scalaVersion := "2.13.18"))
...
homepage := Some(url("https://github.com/StackVista/pekko-http-pac4j"))

scmInfo := Some(ScmInfo(url("https://github.com/StackVista/pekko-http-pac4j"), "scm:git@github.com:StackVista/pekko-http-pac4j.git"))
